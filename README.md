...
-此项目基于vue-admin-template做了二次开发，不满足需求可自行修改

# vue-admin-template介绍
> vue-admin-template一个极简的 vue admin 管理后台。它只包含了 Element UI & axios & iconfont & permission control & lint，这些搭建后台必要的东西。
